...
ENV ENABLE_SIGNUP=false ENABLE_PERSISTENT_CONFIG=false ENABLE_OPENAI_API=true ENABLE_OLLAMA_API=true OLLAMA_BASE_URL=http://127.0.0.1:11435 ENABLE_VERSION_UPDATE_CHECK=false ENABLE_COMMUNITY_SHARING=false ENABLE_EVALUATION_ARENA_MODELS=false WEBUI_URL=https://ful.house WEBUI_NAME=Fullhouse DEFAULT_MODELS=huihui_ai/qwen3-coder-abliterated:30b RAG_EMBEDDING_ENGINE=ollama RAG_EMBEDDING_MODEL=nomic-embed-text:latest ENABLE_RAG_WEB_SEARCH=false ENABLE_CODE_EXECUTION=false ENABLE_CODE_INTERPRETER=false DATA_DIR=/tmp/openwebui
WORKDIR /app/backend
